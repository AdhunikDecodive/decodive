...
export default function NeroChimney() {
  const images3 = [
    {
      original: "https://res.cloudinary.com/dq14b7xie/image/upload/v1746610345/nero90_r6wezc.webp",
      thumbnail: "https://res.cloudinary.com/dq14b7xie/image/upload/v1746610345/nero90_r6wezc.webp",
      originalAlt: "Adhunik DecoDive Nero ( 90 cm ) with BLDC motor | Filterless Autoclean Chimney with 10 year Warranty |BLACK | 1400m3/hr Suction Power",
  ...
  const features = [
    ...
    "Max Suction – 1400 m3/hr Airflow",
  ...
  const technicalDetails = [
    { label: "Maximum Suction", value: "1400 m3/hr" },
    { label: "Chimney Type", value: "Curved Glass Chimney" },
    { label: "Mounted Type", value: "Wall Mounted" },

    { label: "Size", value: " 90cm (Suitable for 3-5 Burner Stove) s" },
    ...
    ,
    {
 label:"Dimensions" , value : "42D*90W*50H in cm"
    },
    {
