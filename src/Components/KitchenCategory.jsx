...
import { Gem, Shield, Droplets,   Heart, Zap, RulerIcon, HammerIcon, PhoneCall, Wand2, BookImage } from 'lucide-react';
    ...
    <>
      ...
      <div className="w-auto  bg-white p-5">
       ...
       <div className="box w-full h-full">
                               <img src="https://res.cloudinary.com/dq14b7xie/image/upload/v1756718329/Modular_kitchen_y9n9bw.webp"
                  className='hidden md:block  h-full w-full  object-center object-cover'
                  alt="  Addressable Fire Alarm System"
                />

                <img
                src="https://res.cloudinary.com/dq14b7xie/image/upload/v1756718392/1_hzu2vb.webp"
            ...
            <div className="w-full h-full p-9 bottom-0 flex-col justify-center md:justify-between  flex md:flex-row  md:text-center  items-center mx-auto  absolute">
              ...
              <div className=" hidden lg:block w-fit border-cyan-500 border-[1px] rounded-lg text-center p-5 bg-[#fffffb]">
          ...
          <div className="w-full h-full md:p-9 mt-8  text-justify md:text-center">
         ...
         <div className="container mx-auto flex justify-center my-8">
              <div className=" lg:hidden block w-fit border-cyan-500 border-[1px] rounded-lg text-center p-5 bg-[#fffffb]">
                <p className="text-2xl">Modular Kitchen Styles</p>
                <p className="bg-black w-fit mx-auto text-white p-1 relative rounded-full  mt-9">
                  Starting
                </p>
