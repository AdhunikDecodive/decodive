    ...
    const PcardData = [
        {
            ...
            title: '',
            description:
                ' Two-door wardrobes with shades of green and white hue made of wooden dresser with three drawers.',
        },
        {
            id: 2,
            imageUrl:
            ...
            title: '',
            description:
                'A two-door wardrobe with a handleless design with a matte finish and reaches the ceiling for maximum storage space.',
        },
        {
            id: 3,
            imageUrl:
            ...
            title: '',
            description:
                'A contemporary two white, two-door wardrobes with gold-toned pulls a shelf unit for showcasing decorative objects.',
        },
        {
            id: 4,
            imageUrl:
        ...
        },
        {
            ...
            title: '',
            description:
                'The off-white double-door wardrobes with drawers and a mirror made up of wood with a glossy finish.',
        },
        {
            id: 7,
            imageUrl:
            ...
            title: '',
            description:
                'The built-in double-door wardrobes with a smooth, laminate green finish with a contemporary, minimalist design.',
        },
    ...
    const P2cardData = [
        {
            ...
            title: '',
            description:
                'Wooden double door wardrobes design with chevron pattern and offer ample storage space creating geometric aesthetic.',
        },
        {
            id: 2,
            imageUrl:
            ...
            title: '',
            description:
                'Two-door wardrobes with a lacquered finish forest green color and integrated pulls with a polished gold finish, with touch of sophistication. ',
        },
        {
            id: 3,
            imageUrl:
            ...
            title: '',
            description:
                'A pair of contemporary, two-door wooden wardrobes with a natural wood finish reinforces the modern, minimalist aesthetic.',
        },
        {
            id: 4,
            imageUrl:
            ...
            title: '',
            description:
                'White double door wardrobes with a chevron pattern. Made for durability with high-quality laminated board and pvc edges. Gold metal handles add a touch of style.',
        },
        {
            id: 5,
            imageUrl:
            ...
            title: '',
            description:
                'Pair of built-in double door wardrobes with a white laminate finish and wooden panel with ample storage capacity.',
        },
        {
            id: 6,
            imageUrl:
            ...
            title: '',
            description:
                'Wooden double door wardrobe with a glossy finish offering a sleek and contemporary aesthetic look',
        },
        {
            id: 7,
            imageUrl:
...
<HelmetProvider>
  ...
  <link rel="canonical" href="https://adhunikdecodive.com/Door2Wardrobe" data-react-helmet="true"/>
...
<ModalNew  isOpen={openModal} onClose={toggleModal}  />
          ...
          <div className="w-[80%] flex">
            ...
            Living spaces deserve to be both stylish and functional. But when overflowing closets leave you feeling like you're wrestling with an avalanche of clothes, it's time to upgrade your storage game. Enter the world of double door wardrobes – where organization meets elegance with more functionality. But functionality isn't the only story. Adhunik Deco offers a stunning selection of double door wardrobes, designed to complement any décor. Explore the design and discover a variety of finishes, materials, and styles to find the perfect match for your unique space. Whether you crave a sleek and modern aesthetic or a touch of classic elegance, there's a double door wardrobe waiting to transform your bedroom into a haven of organized style
            </p>
          </div>
        </div>
