...
<Helmet>
  ...
  <meta name="description" content="Adhunik DecoDive specializes in transforming home decor, offering bespoke solutions that enhance your living space with style and functionality." data-react-helmet="true"/>
        ...
        <ModalNew  isOpen={openModal} onClose={toggleModal}  />
            ...
            <div className="w-auto  bg-white p-5">
               ...
               muted
                autoPlay
                loop preload="auto" playsInline
                cldVid={cld.video('Videos/hd_l6wclb').quality('auto')}
                alt="Home Decor Ideas Light Up Your Style" className="   relative   h-[86vh]  md:h-[45vh] w-full object-cover rounded-lg "
              />
                        ...
                        Home Decor Ideas..
                                <br />
                                <span className=" text-[22px]"> Light Up Your Style</span>
                            </p>
                            <div className="w-fit border-cyan-500 border-[1px] rounded-lg text-center p-5 bg-[#fffffb]">
                                <p className="text-2xl">Decor Designs</p>
