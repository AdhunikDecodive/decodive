...
const styles = {
    backgroundImage: "url('https://res.cloudinary.com/dq14b7xie/image/upload/v1748242220/footer_5_zfsvkm.webp')",
...
function Footer() {
    ...
    const handleMapClick2 = () => {
        ...
        const mapUrl = `https://maps.app.goo.gl/kP86YT5qDiBGLXKP6`;
    ...
    return (
        ...
        <>
            ...
            <footer className="bg-[#F3F3F3] text-center h-auto w-auto font-['Rejouice-Headline']   lg:text-left text-white "
                style={styles} >
                ...
                <div className="mx-6 pt-8 pb-1 text-center md:text-left">
                    <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div>
                            ...
                            <p className="mb-4 flex items-center justify-center md:justify-start cursor-pointer" onClick={handleMapClick2}>
                                <span className="me-3 h-5 w-5 ">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                        <path
                                            d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.06l-8.689-8.69a2.25 2.25 0 00-3.182 0l-8.69 8.69a.75.75 0 001.061 1.06l8.69-8.69z" />
                               ...
                               Ashoka Marg, Lane No.13, <br /> Ramnagar, Roorkee, Uttarakhand 247667
                            </p>
                        ...
                        <div>
                            ...
                            <p className="mb-4">
                                <Link to="/wardrobes" className="link link--thebe">
                            ...
                            <p className="mb-4">
                                <Link to="/home-decors" className="link link--thebe">
                                ...
                                <div className="w-full h-full">
                                    <div className="row flex   flex-wrap  md:justify-left md:justify-start justify-center gap-4 cursor-pointer">
                                        ...
                                        <Tooltip content="x" style="light" placement="bottom">
                                            ...
                                            >
                                                <svg className="fill-white z-10 transition-all duration-300 group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
                                        ...
                                        <Tooltip content="pinterest" style="light" placement="bottom">
                                            ...
                                            >
                                                <svg className="fill-white relative z-10 transition-all duration-300 group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 71 72" fill="none">
                                        ...
                                        <Tooltip content="youtube" style="light" placement="bottom">
                                            <a href="https://www.youtube.com/@AdhunikDecoDive" aria-label="Adhunik DecoDive YouTube Channel" className="w-10 h-10 flex items-center relative overflow-hidden justify-center rounded-full   group transition-all duration-300">
                                                <svg className="fill-white relative z-10 transition-all duration-300 group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 72 72" fill="none">
                                                    ...
                                                    <path className="fill-black transition-all duration-300 group-hover:fill-[#FF3000]" d="M30.8811 44.1617L44.4392 36.3124L30.8811 28.463V44.1617Z" fill="white">
                                                    </path>
                                                </svg>
                                        ...
                                        <Tooltip content="linkedin" style="light" placement="bottom">
                                            <a href="https://www.linkedin.com/in/adhunik-decodive-032347337/" className="w-10 h-10 flex items-center relative overflow-hidden justify-center rounded-full   group transition-all duration-300">
                                                <svg className="fill-white relative z-10 transition-all duration-300 group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
