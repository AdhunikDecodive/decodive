...
function ThankYouPage() {
    ...
    useEffect(() => {
      ...
      // Clean up interval on unmount or when seconds reach 0
    ...
    return (
        <>
            <div className="w-full h-screen" >
                      ...
                      effect="blur" 
                    className=" absolute object-cover h-full w-full" alt="Thank You page" cldImg={cld.image('Images/InterioBanner_jlqvnk')} />
        
                <div className="row flex-col flex md:flex-row  relative ">
                    <div className="w-4/12 h-auto md:h-screen  ">

                    </div>
                    <div className=" w-full lg:w-8/12 h-auto lg:h-screen  p-10  ">

                        <div className="w-full h-full flex flex-col justify-center items-center backdrop-blur-lg md:backdrop-blur-sm bg-white/40 md:bg-white/30  rounded-lg">

                            <h1 className=" text-[15vw] md:text-[10vw]"> Thank You</h1>
                            <p className=" m-4 w-[80%] text-center md:text-2xl "> for providing us your details.
                                <br />
                                Our team will get back to you shortly  </p>
                                <p>Redirecting to Home Page in  {seconds}</p>


                            <p className=" md:text-3xl p-4 text-center ">

                                FOLLOW US ON SOCIAL MEDIA
                            </p>


                            <div className="text-center row flex  md:justify-left md:justify-start justify-center gap-4 p-4">
                            <div className="w-full h-full">
                                    <div className="row flex  md:justify-left md:justify-start justify-center gap-4">
                            ...
                            <a href="https://adhunikdecodive.com/" className=" p-4 text-center"> adhunikdecodive.com</a>
                        </div>
                    </div>
                </div>
            </div>
